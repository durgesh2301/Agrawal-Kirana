<%-- 
    Document   : AdminLogin
    Created on : 10 Apr, 2019, 8:02:22 AM
    Author     : HP
--%>
...
//              rs=Utility.SqlUtil.read(query);
              ...
              session.setAttribute("uname",name);
               out.println("<script>alert('succes');document.location.href='adminresponse.jsp';</script>");
              System.out.println(name);
             
              }
              else
              {
                  out.println("<script>alert('plz enter correct');document.location.href='AdminLogin.jsp';</script>");
